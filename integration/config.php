...
return [
    ...
    'urlSimpla'     => 'https://krasnodar-matrassia.ru', // URL интернет-магазина - необходимо для запуска скриптов из консоли сервера
    'urlRetail'     => 'https://matrassia2.retailcrm.ru', // URL RetailCRM, в которую будут выгружаться данные
    'siteCode'      => 'matrassia-krasnodar', // Код интернет-магазина, прописанный в настройках RetailCRM
    'keyRetail'     => 'XTXBEkYuqXRTzG0zJyzryLQbhQ6P7fOY', // Персональный ключ RetailCRM для доступа к API
